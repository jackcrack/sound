...
module.exports = env => {
  ...
  return {
    ...
    output: {
      path: resolve( 'dist' ),
      filename: pathData => {
        return pathData.chunk.name === 'main' ? 'vmagic.min.js' : 'vendors/vmagic-vendors.min.js';
      },
      chunkFilename: pathData => {
        ...
        return pathData.chunk.chunkReason ? `vendors/vmagic-${ fileName }.min.js` : `components/vmagic_[id].min.js`;
      },
      publicPath: 'js/',
    },
    resolve: {
